...
const EditJobPage = ({ updateJobSubmit }) => {
  ...
  // Initialize the state with values from the `job` object.
      ...
      <div className="container m-auto max-w-2xl py-24">
        <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          <form onSubmit={submitForm}>
            ...
            <div>
              <button
                className="bg-blue-900 hover:bg-black text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
                type="submit"
              >
                Update Job
              </button>
